...
[Пример 1. VML](demos/1-vml/) (только IE8 и ниже).
...
[Пример 2. Формулы в VML](demos/2-vml-formulas/) (только IE8 и ниже).
...
[Пример 3. VML и пикселы](demos/3-vml-pixels/) (только IE8 и ниже).
...
[Пример 4.1. VML и содержимое страницы](demos/4-1-vml-pos-ib/).
...
[Пример 5. Закруглённые уголки в VML](demos/5-vml-roundies/).
